...
public class FormDangNhap {
	...
	public void initComponets() {
		...
		lblPassword.setFont(new Font("Ariral", Font.BOLD, 14));
		...
		txtfMatKhau.setEchoChar('*');
		txtfMatKhau.setFont(new Font("Ariral", Font.PLAIN, 14));
		...
		btnDangNhap.setFont(new Font("Ariral", Font.BOLD, 18));   
		btnDangNhap.setBackground(new Color(0, 139, 139));
		...
		btnThoat.setFont(new Font("Ariral", Font.BOLD, 18));
	...
	private void XuLyDangNhap() {
		...
		USERSDTO UserLogin = USERSBLL.getTaiKhoanDangNhap(txtfTenTaiKhoan.getText(),txtfMatKhau.getText());
        if (UserLogin != null) {
