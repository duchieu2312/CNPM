...
public class FormQLKhachHang {
	...
	public FormQLKhachHang(USERSDTO UserLogin) {
		initComponents();
		userlogin = UserLogin;
	...
	private void initComponents() {
		...
		lblDSKH.setFont(new Font("Arial", Font.BOLD, 24));
		lblDSKH.setBounds(10, 83, 400, 35);
		pnMain.add(lblDSKH);
		
		table = new JTable();
		table.setFont(new Font("Arial", Font.BOLD, 18));
		table.setBorder(new LineBorder(new Color(0, 0, 0)));
		table.setBounds(230, 94, 560, 475);
		JScrollPane scrollPane = new JScrollPane(table);
		scrollPane.setBounds(10, 151, 988, 600);
		table.setBounds(230, 94, 560, 475);
		...
		dtm.addColumn("Số lượng đơn GD");
		table.setModel(dtm);
		
		JButton btnThem = new JButton("Thêm");
		btnThem.setBorder(null);
		btnThem.setBackground(SystemColor.controlHighlight);
		btnThem.setForeground(Color.RED);
		btnThem.setFont(new Font("Arial", Font.BOLD, 18));
		btnThem.setBounds(266, 761, 149, 29);
		pnMain.add(btnThem);
		...
		btnXoa.setBounds(435, 761, 149, 29);
		pnMain.add(btnXoa);
		
		JButton btnSua = new JButton("Sửa");
		btnSua.setBorder(null);
		btnSua.setBackground(SystemColor.controlHighlight);
		btnSua.setForeground(Color.RED);
		btnSua.setFont(new Font("Arial", Font.BOLD, 18));
		btnSua.setBounds(607, 761, 149, 29);
		pnMain.add(btnSua);
	}
